...
namespace SchoolManagementSystem {
    ...
    public partial class SchoolManagementSystemDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentsRow AddStudentsRow(int StudentID, string Name, string Gender, System.DateTime DOB, int Class, string Grade) {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([StudentID] = @Original_StudentID) AND ([Nam" +
                "e] = @Original_Name) AND ([Gender] = @Original_Gender) AND ([DOB] = @Original_DO" +
                "B) AND ([Class] = @Original_Class) AND ([Grade] = @Original_Grade))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([StudentID], [Name], [Gender], [DOB], [Class], [Gra" +
                "de]) VALUES (@StudentID, @Name, @Gender, @DOB, @Class, @Grade);\r\nSELECT StudentI" +
                "D, Name, Gender, DOB, Class, Grade FROM Students WHERE (StudentID = @StudentID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [StudentID] = @StudentID, [Name] = @Name, [Gender] = @Gender, [DOB] = @DOB, [Class] = @Class, [Grade] = @Grade WHERE (([StudentID] = @Original_StudentID) AND ([Name] = @Original_Name) AND ([Gender] = @Original_Gender) AND ([DOB] = @Original_DOB) AND ([Class] = @Original_Class) AND ([Grade] = @Original_Grade));
SELECT StudentID, Name, Gender, DOB, Class, Grade FROM Students WHERE (StudentID = @StudentID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, Name, Gender, DOB, Class, Grade FROM dbo.Students";
        ...
        public virtual int Delete(int Original_StudentID, string Original_Name, string Original_Gender, System.DateTime Original_DOB, int Original_Class, string Original_Grade) {
        ...
        public virtual int Insert(int StudentID, string Name, string Gender, System.DateTime DOB, int Class, string Grade) {
        ...
        public virtual int Update(int StudentID, string Name, string Gender, System.DateTime DOB, int Class, string Grade, int Original_StudentID, string Original_Name, string Original_Gender, System.DateTime Original_DOB, int Original_Class, string Original_Grade) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Gender, System.DateTime DOB, int Class, string Grade, int Original_StudentID, string Original_Name, string Original_Gender, System.DateTime Original_DOB, int Original_Class, string Original_Grade) {
            return this.Update(Original_StudentID, Name, Gender, DOB, Class, Grade, Original_StudentID, Original_Name, Original_Gender, Original_DOB, Original_Class, Original_Grade);
        }
    }
